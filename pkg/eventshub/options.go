...
func StartSender(sinkSvc string) EventsHubOption {
	return compose(envAdditive("EVENT_GENERATORS", "sender"), func(ctx context.Context, envs map[string]interface{}) error {
...
func InputEvent(event cloudevents.Event) EventsHubOption {
	...
	if err != nil {
		return func(ctx context.Context, envs map[string]interface{}) error {
			return err
		}
	}
